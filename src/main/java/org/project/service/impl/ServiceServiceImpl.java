...
public class ServiceServiceImpl implements ServiceService {
    ...
    public Page<ServiceResponse> getServices(int index, int size, ServiceDTO serviceDTO) {
        ...
        List<SearchCriteria> searchCriterias = List.of(
                new SearchCriteria(FieldNameUtils.joinFields(ServiceEntity.Fields.productEntity, ProductEntity.Fields.name), ComparisonOperator.CONTAINS, serviceDTO.getProductEntityName(), JoinType.LEFT),
                new SearchCriteria(FieldNameUtils.joinFields(ServiceEntity.Fields.productEntity, ProductEntity.Fields.description), ComparisonOperator.CONTAINS, serviceDTO.getProductEntityDescription(), JoinType.LEFT),
                new SearchCriteria(FieldNameUtils.joinFields(ServiceEntity.Fields.departmentEntity, DepartmentEntity.Fields.id), ComparisonOperator.EQUALS, serviceDTO.getDepartmentEntityId(), JoinType.LEFT),
                new SearchCriteria(FieldNameUtils.joinFields(ServiceEntity.Fields.productEntity, ProductEntity.Fields.price), ComparisonOperator.GREATER_THAN_OR_EQUAL_TO, serviceDTO.getMinPrice(), JoinType.LEFT),
                new SearchCriteria(FieldNameUtils.joinFields(ServiceEntity.Fields.productEntity, ProductEntity.Fields.price), ComparisonOperator.LESS_THAN_OR_EQUAL_TO, serviceDTO.getMaxPrice(), JoinType.LEFT),
                new SearchCriteria(FieldNameUtils.joinFields(ServiceEntity.Fields.productEntity, ProductEntity.Fields.reviewEntities, ReviewEntity.Fields.rating), ComparisonOperator.AVG_GREATER_THAN_OR_EQUAL_TO, serviceDTO.getMinStarRating(), JoinType.LEFT),
                new SearchCriteria(FieldNameUtils.joinFields(ServiceEntity.Fields.productEntity, ProductEntity.Fields.reviewEntities, ReviewEntity.Fields.id), ComparisonOperator.COUNT_GREATER_THAN_OR_EQUAL_TO, serviceDTO.getMinReviewCount(), JoinType.LEFT),
        ...
        Map<String, SortCriteria> sortCriteriaMap = Map.of(
                FieldNameUtils.joinFields(ServiceEntity.Fields.productEntity, ProductEntity.Fields.name),
                new SortCriteria(serviceDTO.getSortFieldName(), AggregationFunction.NONE, serviceDTO.getSortDirection(), JoinType.LEFT),
                FieldNameUtils.joinFields(ServiceEntity.Fields.productEntity, ProductEntity.Fields.price),
                new SortCriteria(serviceDTO.getSortFieldName(), AggregationFunction.NONE, serviceDTO.getSortDirection(), JoinType.LEFT),
                FieldNameUtils.joinFields(ServiceEntity.Fields.productEntity, ProductEntity.Fields.reviewEntities, ReviewEntity.Fields.rating),
                new SortCriteria(serviceDTO.getSortFieldName(), AggregationFunction.AVG, serviceDTO.getSortDirection(), JoinType.LEFT),
                FieldNameUtils.joinFields(ServiceEntity.Fields.productEntity, ProductEntity.Fields.reviewEntities, ReviewEntity.Fields.id),
                new SortCriteria(serviceDTO.getSortFieldName(), AggregationFunction.COUNT, serviceDTO.getSortDirection(), JoinType.LEFT),
                FieldNameUtils.joinFields(ServiceEntity.Fields.departmentEntity, DepartmentEntity.Fields.id),
                new SortCriteria(serviceDTO.getSortFieldName(), AggregationFunction.NONE, serviceDTO.getSortDirection(), JoinType.LEFT));
